...
extension Scheduler
where
  SchedulerTimeType == CXWrappers.DispatchQueue.SchedulerTimeType,
  SchedulerOptions == CXWrappers.DispatchQueue.SchedulerOptions
{
...
extension Scheduler
where
  SchedulerTimeType == CXWrappers.RunLoop.SchedulerTimeType,
  SchedulerOptions == CXWrappers.RunLoop.SchedulerOptions
{
  public static var immediateScheduler: ImmediateSchedulerOf<Self> {
...
extension Scheduler
where
  SchedulerTimeType == CXWrappers.OperationQueue.SchedulerTimeType,
  SchedulerOptions == CXWrappers.OperationQueue.SchedulerOptions
{
  public static var immediateScheduler: ImmediateSchedulerOf<Self> {
    ImmediateScheduler(now: SchedulerTimeType(Date(timeIntervalSince1970: 0)))
  }
...
> where Scheduler: CXShim.Scheduler
